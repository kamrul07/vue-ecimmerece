            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10" style="height:auto;">
                            <img :src="productDetails.thumbnail" alt="" class="object-contain w-full h-full ">
                        </div>
                        <div class="flex-wrap hidden md:flex ">
                            <div v-for="image in productDetails.images" :key="image" class="w-1/2 p-2 sm:w-1/4">
                                <a href="#"
                                    class="block border border-blue-100 dark:border-gray-700 dark:hover:border-gray-600 hover:border-blue-300 ">
                                    <img :src="image" alt="" class="object-cover w-full lg:h-32">
                                </a>
                            </div>
                        </div>
                    </div>
